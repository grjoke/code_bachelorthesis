...
if os.path.isdir('files_period_time_seaborn_nL'):
    shutil.rmtree('files_period_time_seaborn_nL')
os.mkdir('files_period_time_seaborn_nL')

def write_results_in_file(array, fname):
    if os.path.exists('files_period_time_seaborn_nL/' + fname + '.txt'):
        os.remove('files_period_time_seaborn_nL/' + fname + '.txt')
    print(array, file = open('files_period_time_seaborn_nL/' + fname + '.txt', 'a'))
    return 0
...
def fit_cycle_array(amplitude_array, value_array):
    popt, pconv = curve_fit(distfunc_fit, amplitude_array, value_array) #, p0=[10., 1., 0.01, -1.]
    return popt, pconv
...
if os.path.exists('files_period_time_seaborn_nL/param_cyclefit_period_time_random_1.txt'):
    os.remove('files_period_time_seaborn_nL/param_cyclefit_period_time_random_1.txt')
print('amp = ' + str(popt_1[0]) + ', k = ' + str(popt_1[1]) + ', cx = ' + str(popt_1[2]) + ', cy = ' + str(popt_1[3]) + ', error = ' + str(err1), file = open('files_period_time_seaborn_nL/param_cyclefit_period_time_random_1.txt', 'a')) # ', cx = ' + str(popt_1[2]) + #', cx = ' + str(popt_1[2]) + ', cy = ' + str(popt_1[3]) +
if os.path.exists('files_period_time_seaborn_nL/param_cyclefit_period_time_random_2.txt'):
    os.remove('files_period_time_seaborn_nL/param_cyclefit_period_time_random_2.txt')
print('amp = ' + str(popt_2[0]) + ', k = ' + str(popt_2[1]) + ', cx = ' + str(popt_2[2]) + ', cy = ' + str(popt_2[3]) + ', error = ' + str(err2), file = open('files_period_time_seaborn_nL/param_cyclefit_period_time_random_2.txt', 'a')) #', cx = ' + str(popt_2[2]) + #', cx = ' + str(popt_2[2]) + ', cy = ' + str(popt_2[3]) +
...
def plot_the_results(amplitude_array, period_time_array, cycle_array, amplitudes_cycle, res_regression, popt, fname): #popt
    ...
    plt.grid()
    plt.tight_layout()
    plt.savefig('files_period_time_seaborn_nL/' + fname + '.pdf')
    plt.savefig('files_period_time_seaborn_nL/'+ fname + '.png')
    #plt.show()
    plt.clf()
    ...
    plt.grid()
    plt.tight_layout()
    plt.savefig('files_period_time_seaborn_nL/' + fname + '_seaborn.pdf')
    plt.savefig('files_period_time_seaborn_nL/'+ fname + '_seaborn.png')
    #plt.show()
    plt.clf()
    ...
    plt.grid()
    plt.tight_layout()
    plt.savefig('files_period_time_seaborn_nL/' + fname + '_cycles.pdf')
    plt.savefig('files_period_time_seaborn_nL/' + fname + '_cycles.png')
    #plt.show()
    plt.clf()



plot_the_results(amplitudes_1, period_time_1, number_of_cycles_1, amplitudes_cycles_1, res1, popt_1, fname = 'period_time_gaussian_noise_1_nL') # popt_1,
plot_the_results(amplitudes_2, period_time_2, number_of_cycles_2, amplitudes_cycles_2, res2, popt_2, fname = 'period_time_gaussian_noise_2_nL') # popt_2,
